...
ADMINS = (
    ('Stuart Larsen', 'poptarts4liffe@gmail.com'),
)
...
SECRET_KEY = 'h7(c1og@_(4_-d5(j_xc9=_bi!!y^-b^z&2cl(_%#6qnz4eg_o'
...
ROOT_URLCONF = 'lifeTrackerSite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lifeTrackerSite.wsgi.application'
