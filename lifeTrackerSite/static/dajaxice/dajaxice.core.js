...
var Dajaxice = {
    ...
    deleteEvent: function(callback_function, argv, custom_settings){
        return Dajaxice.call('lifetracker.deleteEvent', 'POST', callback_function, argv, custom_settings);
    },

    addEvent: function(callback_function, argv, custom_settings){
        return Dajaxice.call('lifetracker.addEvent', 'POST', callback_function, argv, custom_settings);
    },

    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('lifetracker.sayhello', 'POST', callback_function, argv, custom_settings);
    },

    editEvent: function(callback_function, argv, custom_settings){
        return Dajaxice.call('lifetracker.editEvent', 'POST', callback_function, argv, custom_settings);
    }
